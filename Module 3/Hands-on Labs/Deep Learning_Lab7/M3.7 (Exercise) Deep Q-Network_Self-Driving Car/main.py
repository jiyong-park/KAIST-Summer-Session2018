...
##################################################################################
# Exercise 4                                                                     #
# Add more signals for the car                                                   #
# More signals may help the car recognize the states and take relavent actions   #
################################################################################## 
...
dqn_rotation = DQN(4, 5, 0.95, 0.005)                   # 4 signals, 5 actions, gamma = 0.95, epsilon = 0.001
action2rotation = [0, 15, -15, 40, -40]                 # action for rotation (degree)

dqn_velocity = DQN(4, 3, 0.95, 0.005)                   # 4 signals, 3 actions, gamma = 0.95, epsilon = 0.001
